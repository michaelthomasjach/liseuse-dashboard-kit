...
import { SearchIcon, SettingsIcon, TrashIcon, InfoIcon, OverlayBadgeIcon, PaneBadgeIcon, CheckIcon, CodeIcon, EyeOffIcon, TrendLineIcon, StarIcon, ChevronLeftIcon, ChevronRightIcon } from "../../../icons";
...
export function IndicatorModals({
  ...
  }, [measureCategoryOverflow, indicatorPickerOpen, scripts.length]);
