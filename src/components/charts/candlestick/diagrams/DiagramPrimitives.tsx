...
/** A captured illustration, at the top of an indicator's or a drawing tool's own info modal.
 *
 *  Full width on purpose: these are wide, shallow crops of a chart, and a modal that padded them
 *  in would be spending its widest dimension on nothing. The border is what separates the capture
 *  from the modal's own surface — without it a light chart bleeds into a light panel. */
