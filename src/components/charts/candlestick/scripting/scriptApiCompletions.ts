...
export const SCRIPT_API_COMPLETIONS: ScriptApiCompletion[] = [
  ...
  },
  {
    label: "@indicator",
    type: "keyword",
    detail: "déclare un script qui dessine sur la chart — le cas par défaut",
    apply: "@indicator",
  },
  {
    label: "@strategy",
    type: "keyword",
    detail: "déclare un script qui prend des positions — donne accès à strategy.* et ouvre le panneau de test",
    apply: "@strategy",
  },
  {
    label: "strategy",
  ...
  { label: "strategy.long", type: "function", detail: '(commentaire?, { size?, unit? }?) — ouvre ou renforce une position longue' },
  { label: "strategy.short", type: "function", detail: '(commentaire?, { size?, unit? }?) — ouvre ou renforce une position courte' },
  { label: "strategy.close", type: "function", detail: "(commentaire?) — ferme toute la position ouverte" },
  { label: "strategy.position", type: "function", detail: '() => "long" | "short" | "flat"' },
  { label: "strategy.positionSize", type: "function", detail: "() => number — unités détenues" },
  { label: "strategy.averagePrice", type: "function", detail: "() => number | null — prix moyen d'entrée" },
  { label: "strategy.unrealizedProfit", type: "function", detail: "() => number — P&L latent au cours courant" },
  {
    label: "@block",
    type: "keyword",
