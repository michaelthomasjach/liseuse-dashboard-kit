import { IconBase, type AnimatedIconProps } from "./IconBase";
import "./icons.css";

export type { AnimatedIconProps, IconMotion } from "./IconBase";

/** Every icon here takes `animated` and carries its own idle motion — see `IconMotion` for the
 *  vocabulary and why it is a shared one. Off by default, because a dense UI full of moving icons
 *  is unreadable; turn it on for the one instance where motion earns its place.
 *
 *  Adding an icon means adding its `motion` in the same line. It is one word, it is what makes the
 *  icon appear in "Foundations/Animated Icons" (that gallery reads this module's own exports, so
 *  nothing has to be registered anywhere), and an icon without one is an icon that silently does
 *  nothing when a caller passes `animated`. */

export const SunIcon = (props: AnimatedIconProps) => (
...
export const MoonIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
    <path d="M20 14.2A8.5 8.5 0 1 1 9.8 4a6.6 6.6 0 0 0 10.2 10.2Z" />
  </IconBase>
);

export const CloudIcon = (props: AnimatedIconProps) => (
  <IconBase motion="float" {...props}>
    <path d="M7 18h10a4 4 0 0 0 0-8 5.5 5.5 0 0 0-10.5 1.6A3.5 3.5 0 0 0 7 18Z" />
  </IconBase>
);

/* Two icons animate a *part* of themselves rather than the whole, so they set the class on the
   child and leave `motion` unset — spinning the cloud along with its sun would be a weather map in
   a tumble dryer. `animated` is still consumed here, never forwarded to the <svg>. */
...
export const WindIcon = (props: AnimatedIconProps) => (
...
export const AlertTriangleIcon = (props: AnimatedIconProps) => (
...
export const SunriseIcon = (props: AnimatedIconProps) => (
...
export const SunsetIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <path d="M12 8V3" />
    <path d="M5.5 11.5 7.6 9.4M18.5 11.5l-2.1-2.1" />
    <circle cx="12" cy="15" r="3.6" />
...
export const BedIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
...
export const LogoutIcon = (props: AnimatedIconProps) => (
...
export const HomeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const NextTrackIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
...
export const SpeakerIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
...
export const SolarPanelIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
...
export const BatteryIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
...
export const GridPlugIcon = (props: AnimatedIconProps) => (
  <IconBase motion="blink" {...props}>
    <path d="M12 2.5v6" />
...
export const ChevronRightIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
    <path d="M9 5.5 15.5 12 9 18.5" />
  </IconBase>
);

export const CloseIcon = (props: AnimatedIconProps) => (
  <IconBase motion="shake" {...props}>
...
export const ChevronUpIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <path d="M5.5 15 12 8.5 18.5 15" />
  </IconBase>
);

export const ChevronLeftIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
    <path d="M15 5.5 8.5 12 15 18.5" />
  </IconBase>
);

export const CheckIcon = (props: AnimatedIconProps) => (
  <IconBase motion="grow" {...props}>
    <path d="M5 12.5 9.5 17 19 6.5" />
  </IconBase>
);

export const SearchIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const EyeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="blink" {...props}>
...
export const EyeOffIcon = (props: AnimatedIconProps) => (
  <IconBase motion="blink" {...props}>
...
export const UserIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
...
export const LockIcon = (props: AnimatedIconProps) => (
...
export const GripIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const LayersIcon = (props: AnimatedIconProps) => (
  <IconBase motion="float" {...props}>
...
export const OverlayBadgeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
    <path d="M4 16h16" />
...
export const PaneBadgeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
...
export const ErrorIcon = (props: AnimatedIconProps) => (
  <IconBase motion="shake" {...props}>
...
export const InfoIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
    <circle cx="12" cy="12" r="9" />
    <path d="M12 11v5.5" />
...
export const HelpIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
    <circle cx="12" cy="12" r="9" />
...
export const ArrowUpIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <path d="M12 19V5M6 10.5 12 5l6 5.5" />
  </IconBase>
);

export const ArrowDownIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <path d="M12 5v14M6 13.5 12 19l6-5.5" />
  </IconBase>
);

export const MenuIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <path d="M3.5 6.5h17M3.5 12h17M3.5 17.5h17" />
  </IconBase>
);

export const BellIcon = (props: AnimatedIconProps) => (
  <IconBase motion="ring" {...props}>
...
export const WatchlistIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const PieChartIcon = (props: AnimatedIconProps) => (
  <IconBase motion="spin" {...props}>
...
export const SettingsIcon = (props: AnimatedIconProps) => (
  <IconBase motion="spin" {...props}>
...
export const LinkIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const GridIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
...
export const CreditCardIcon = (props: AnimatedIconProps) => (
  <IconBase motion="tilt" {...props}>
...
export const RefreshIcon = (props: AnimatedIconProps) => (
  <IconBase motion="spin" {...props}>
...
export const UploadCloudIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const FileIcon = (props: AnimatedIconProps) => (
  <IconBase motion="float" {...props}>
...
export const SaveIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const TrashIcon = (props: AnimatedIconProps) => (
  <IconBase motion="tilt" {...props}>
...
export const FolderIcon = (props: AnimatedIconProps) => (
  <IconBase motion="tilt" {...props}>
    <path d="M3.5 6.5a1 1 0 0 1 1-1h4.7l1.6 2h8.7a1 1 0 0 1 1 1v9.5a1 1 0 0 1-1 1h-15a1 1 0 0 1-1-1Z" />
  </IconBase>
);

export const MaximizeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="grow" {...props}>
...
export const DetachWindowIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
...
export const MinimizeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="grow" {...props}>
    <path d="M4.5 8.5H9V4M19.5 8.5H15V4M4.5 15.5H9V20M19.5 15.5H15V20" />
  </IconBase>
);

export const StarIcon = (props: AnimatedIconProps) => (
  <IconBase motion="beat" {...props}>
    <path d="M12 3.5l2.6 5.4 5.9.8-4.3 4.2 1 5.9-5.2-2.8-5.2 2.8 1-5.9-4.3-4.2 5.9-.8Z" />
  </IconBase>
);

export const ArrowRightIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
    <path d="M5 12h14M13 6l6 6-6 6" />
  </IconBase>
);

export const PlusIcon = (props: AnimatedIconProps) => (
  <IconBase motion="grow" {...props}>
...
export const MoreHorizontalIcon = (props: AnimatedIconProps) => (
  <IconBase motion="blink" {...props}>
...
export const CopyIcon = (props: AnimatedIconProps) => (
  <IconBase motion="flip" {...props}>
...
export const CursorArrowIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <path d="M5 3.5 18.5 9.8 12.6 12.2 10 18.3Z" strokeLinejoin="round" />
  </IconBase>
);

export const TrendLineIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
    <path d="M4 18 18 6" />
...
export const HorizontalLineIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <path d="M4 12h16" />
    <circle cx="12" cy="12" r="1.6" fill="currentColor" stroke="none" />
  </IconBase>
...
export const VerticalLineIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
    <path d="M12 4v16" />
    <circle cx="12" cy="12" r="1.6" fill="currentColor" stroke="none" />
  </IconBase>
...
export const HorizontalRayIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
    <path d="M7 12h13" />
...
export const ExtendedLineIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
    <path d="M2 20 22 4" />
...
export const ChannelIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
    <path d="M3 19 16 6" />
    <path d="M8 21 21 8" />
...
export const DisjointChannelIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
    <path d="M3 5 21 11" />
    <path d="M3 19 21 13" />
...
export const FibonacciIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <path d="M4 4h4" />
    <path d="M4 8.5h9" />
    <path d="M4 13h14" />
...
export const FibonacciExtensionIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <path d="M2 6h6" />
    <path d="M2 12h10" />
    <path d="M2 18h6" />
...
export const ElliottWaveIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const ElliottImpulseIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const ElliottCorrectionIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const ActivityIcon = (props: AnimatedIconProps) => (
  <IconBase motion="beat" {...props}>
...
export const GaugeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const CandleModeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const HeikinAshiModeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const RenkoModeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const LineBreakModeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
 ...
 *  point of control. */
export const TpoModeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const MeasureIcon = (props: AnimatedIconProps) => (
  <IconBase motion="grow" {...props}>
...
export const ZoomInIcon = (props: AnimatedIconProps) => (
  <IconBase motion="grow" {...props}>
    <circle cx="10.5" cy="10.5" r="6.5" />
    <path d="M19 19l-4.3-4.3" />
...
export const ZoomOutIcon = (props: AnimatedIconProps) => (
  <IconBase motion="grow" {...props}>
    <circle cx="10.5" cy="10.5" r="6.5" />
    <path d="M19 19l-4.3-4.3" />
    <path d="M7.5 10.5h6" />
...
export const AverageLineIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const MagnetIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const RectangleShapeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="grow" {...props}>
...
export const ElbowArrowIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
...
export const BrushIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const ArrowLineIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
    <path d="M4 18 16 6" />
...
export const ZonesIcon = (props: AnimatedIconProps) => (
  <IconBase motion="pulse" {...props}>
...
export const HeadShouldersIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
 ...
 *  handle) in order. */
export const CupHandleIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const ForecastIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
...
export const RangeForecastIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
...
export const LongPositionIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const ShortPositionIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const PitchforkIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
    <path d="M8 5h13" />
 ...
 *  the handle itself. */
export const SchiffPitchforkIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const ModifiedSchiffPitchforkIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const InsidePitchforkIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
    <path d="M3 5h18" />
    <path d="M3 12h18" strokeDasharray="2.5 2.5" />
    <path d="M3 19h18" />
...
export const PencilIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const TextIcon = (props: AnimatedIconProps) => (
  <IconBase motion="blink" {...props}>
    <path d="M5 6h14" />
    <path d="M12 6v13" />
  </IconBase>
...
export const CommentIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const NoteIcon = (props: AnimatedIconProps) => (
  <IconBase motion="tilt" {...props}>
    <path d="M4 20 11 13" />
...
export const PriceNoteIcon = (props: AnimatedIconProps) => (
  <IconBase motion="tilt" {...props}>
    <path d="M4 20 11 13" />
...
export const PinIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
...
export const FlagMarkIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
    <path d="M6 21V4" />
...
export const SignpostIcon = (props: AnimatedIconProps) => (
  <IconBase motion="sway" {...props}>
...
export const PriceLabelIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
    <path d="M3.5 5.5h17v11h-11l-4 3.5v-3.5h-2z" />
...
export const TableIcon = (props: AnimatedIconProps) => (
  <IconBase motion="bob" {...props}>
    <rect x="3.5" y="4" width="17" height="16" rx="1.5" />
...
export const CrossingIcon = (props: AnimatedIconProps) => (
  <IconBase motion="beat" {...props}>
    <path d="M4 6 20 18" />
    <path d="M20 6 4 18" />
  </IconBase>
...
export const GreaterThanIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
...
export const LessThanIcon = (props: AnimatedIconProps) => (
  <IconBase motion="slide" {...props}>
...
export const CodeIcon = (props: AnimatedIconProps) => (
  <IconBase motion="blink" {...props}>
...
export const SparkleIcon = (props: AnimatedIconProps) => (
  <IconBase motion="beat" {...props}>
